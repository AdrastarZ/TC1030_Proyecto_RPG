...
| Situación | Efecto |
|---|---|
| Escribir una numero, espacio o caracter especial donde espera una cadena de texto | `cin` entra en estado de error. Los siguientes `cin >>` se saltan sin leer nada, causando que variables queden sin inicializar o con basura, lo que puede crashear el programa en la siguiente operación |
